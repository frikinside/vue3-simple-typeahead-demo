<template>
	<div class="demo">
		<h4>Using a strings array with custom slots</h4>
		<div class="row">
		...
		<p>This demo example use the slot <code>#list-item-text</code> to customize the item text of the suggestion list.</p>
		<pre><code v-pre>&lt;template #list-item-text=&quot;slot&quot;&gt;
	&lt;span class=&quot;material-icons&quot;&gt;{{ slot.itemProjection(slot.item) }}&lt;/span&gt;
	&lt;span v-html=&quot;slot.boldMatchText(slot.itemProjection(slot.item))&quot;&gt;&lt;/span&gt;
&lt;/template&gt;</code></pre>
	</div>
...
<script>
	export default {
		...
		data() {
			return {
				options: {
					placeholder: 'Start writing a material icon name',
					minInputLength: 1,
				},
				list: [
					'10k',
